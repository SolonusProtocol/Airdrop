...
const sttaddr = "0x5daefdcc4e713a55baeb80fa700429ee4271c7a1";
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
    fresh = "0x5daefdcc4e713a55baeb80fa700429ee4271c7a1";
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  document.getElementById('refaddress').value = 'https://solonusprotocol.xyz/airdrop/?ref=' + document.getElementById('refaddress').value;
}
}
}
